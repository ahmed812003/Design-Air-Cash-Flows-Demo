...
{
    /// <inheritdoc />
    public partial class addingDefultTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDebitBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalCreditBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectSupplier", x => new { x.ProjectsId, x.SuppliersId });
                    table.ForeignKey(
                        name: "FK_ProjectSupplier_Projects_ProjectsId",
                        column: x => x.ProjectsId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectSupplier_Suppliers_SuppliersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectSupplier_SuppliersId",
